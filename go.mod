module kcl-lang.io/helmfile-kcl
...
require (
	...
	kcl-lang.io/kcl-go v0.5.0 // indirect
	kcl-lang.io/kpm v0.3.0 // indirect
...
replace (
	...
	sigs.k8s.io/kustomize/api => sigs.k8s.io/kustomize/api v0.14.0
